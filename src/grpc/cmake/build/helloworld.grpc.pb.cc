...
::grpc::Status Greeter::Stub::SayHello(::grpc::ClientContext* context, const ::postgresGRPC::HelloRequest& request, ::postgresGRPC::HelloReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::postgresGRPC::HelloRequest, ::postgresGRPC::HelloReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SayHello_, context, request, response);
}

void Greeter::Stub::async::SayHello(::grpc::ClientContext* context, const ::postgresGRPC::HelloRequest* request, ::postgresGRPC::HelloReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::postgresGRPC::HelloRequest, ::postgresGRPC::HelloReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SayHello_, context, request, response, std::move(f));
}

void Greeter::Stub::async::SayHello(::grpc::ClientContext* context, const ::postgresGRPC::HelloRequest* request, ::postgresGRPC::HelloReply* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::postgresGRPC::HelloReply>* Greeter::Stub::PrepareAsyncSayHelloRaw(::grpc::ClientContext* context, const ::postgresGRPC::HelloRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::postgresGRPC::HelloReply, ::postgresGRPC::HelloRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SayHello_, context, request);
}

::grpc::ClientAsyncResponseReader< ::postgresGRPC::HelloReply>* Greeter::Stub::AsyncSayHelloRaw(::grpc::ClientContext* context, const ::postgresGRPC::HelloRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
Greeter::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< Greeter::Service, ::postgresGRPC::HelloRequest, ::postgresGRPC::HelloReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Greeter::Service* service,
             ::grpc::ServerContext* ctx,
             const ::postgresGRPC::HelloRequest* req,
